...
int main(int argc, char const *argv[]) {
    ...
    while (sfRenderWindow_isOpen(window)) {
        ...
        label("Player 1 is red!", 875, 150, 25, sfWhite);  // we use 875 as it is the width of the button below divided by 2 add the x position of the rectangle which gives us the exact coordinates for the centre of the rectangle which means this label is in line with the label of the button below making things look neat

        button(startButton, 250, 50, 750, 200, sfBlue, "Start button", 25, sfWhite);
        button(quitButton, 250, 50, 750, 650, sfBlue, "Quit button", 25, sfWhite);
